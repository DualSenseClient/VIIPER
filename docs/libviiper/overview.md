...
=== "C#"
    ...
    See [`examples/libVIIPER/C#/`](https://github.com/DualSenseClient/VIIPER/tree/main/examples/libVIIPER/C%23) for the full project including P/Invoke declarations.
